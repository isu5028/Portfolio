...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    details: '「明暗境界線の統一的スタイル化手法」という題目で卒業論文を執筆しました。3DCGにおけるNPR（非実写風レンダリング）において重要な役割を果たす明暗境界線（Terminator Line）に対して、ユーザーが意図したスタイルを効率的に適用・制御できる手法を提案し、情報処理学会 第88回全国大会にて口頭発表を行いました。',
